...
<html>
  <head>
    ...
    <title>@dtci/spellbook [24 Apr 2023 at 17:26]</title>
...
//# sourceMappingURL=viewer.js.map</script>
  ...
  <body>
    <div id="app"></div>
    <script>
      window.chartData = [{"label":"spellbook-reset.js","isAsset":true,"statSize":953,"parsedSize":523,"gzipSize":307,"groups":[{"label":"styles","path":"./styles","statSize":953,"groups":[{"id":975,"label":"reset.scss","path":"./styles/reset.scss","statSize":953,"parsedSize":523,"gzipSize":307}],"parsedSize":523,"gzipSize":307}],"isInitialByEntrypoint":{"spellbook-reset":true}}];
      window.entrypoints = ["spellbook-reset"];
